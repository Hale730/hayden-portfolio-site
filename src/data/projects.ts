...
export const projects: Project[] = [
  {
    ...
    palette: { c1: '#0F172A', c2: '#1E3A8A', c3: '#06B6D4', text: '#F0F9FF' },
  },
  {
    ...
    palette: { c1: '#1E3A5F', c2: '#2C5F4A', c3: '#3A3A2E', text: '#EAE7D6' },
  },
  {
    slug: 'palimpsest',
    title: 'Palimpsest',
    ...
    palette: { c1: '#14110F', c2: '#2A1C1C', c3: '#3E2F2A', text: '#E6E1D7' },
    link: {
  ...
  },
  {
    ...
    palette: { c1: '#0A2A1E', c2: '#1F6F3E', c3: '#8B1A1A', text: '#F8F5E9' },
    link: {
      label: 'View on Notion',
  ...
  },
  {
    ...
    palette: { c1: '#2A0E5C', c2: '#7A1FA2', c3: '#D81E5B', text: '#FFF8E7' },
    link: {
      label: 'View on Notion',
  ...
  },
  {
    ...
    palette: { c1: '#2F6B3D', c2: '#6BA368', c3: '#E07A38', text: '#FBFDF7' },
    link: {
      label: 'View on Notion',
  ...
  },
  {
    ...
    palette: { c1: '#0A2A38', c2: '#155E6B', c3: '#2E6E5A', text: '#EAF2F2' },
